        ...
        <tbody>
            ...
            @foreach ($reservations as $reservation)
                <tr>
                    ...
                    <td>{{ \Carbon\Carbon::parse($reservation->check_in)->formatLocalized('%A, %d %B %Y Pukul : %H.%M ') }}</td>
                    <td>{{ \Carbon\Carbon::parse($reservation->check_out)->formatLocalized('%A, %d %B %Y Pukul : %H.%M ') }}</td>
                    <td>
