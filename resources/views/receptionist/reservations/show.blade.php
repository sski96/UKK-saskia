    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <p class="card-text">
                ...
                Tanggal Check In : {{ \Carbon\Carbon::parse($reservation->check_in)->formatLocalized('%A, %d %B %Y Pukul : %H.%M ') }} <br>
                Tanggal Check Out : {{ \Carbon\Carbon::parse($reservation->check_out)->formatLocalized('%A, %d %B %Y Pukul : %H.%M ') }} <br>
                Status : 
                ...
                <a href="{{ route('reservations.index') }}" class="btn  btn-sm btn-secondary mt-2">Kembali</a>
            </p>
        </div>
    </div>    
</div>
